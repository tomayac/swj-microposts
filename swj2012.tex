...
\title{A Comparison of Topics People read about on Facebook and Twitter crossed with Detection of Geolocations of Centers of Interest}
%\subtitle{}
...
\begin{abstract}
Social media mining plays an ever-growing role in 
\end{abstract}
...
\begin{table*}
  ...
  \subfloat[][Facebook Swarm NLP]{
    ...
    \hline
  \end{tabular}
  \label{tab:facebooktoplocations}}
