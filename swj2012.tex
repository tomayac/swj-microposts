...
This measuring method promises interesting new aspects for future research, for example to chose the right social medium for a~certain data mining task.
On the economical side, business can use social media consumer behavior to develop advertising strategies, since today, they still depend on producer behavior as a second-degree estimation.
