...
\begin{table*}
  \centering
    ...
    \hline
  \end{tabular}
  \tablecaption{Twitter users relatively consume more distinct entities than Facebook users do.\\* However, Facebook sessions take generally longer, which may account for this difference.}
  \label{tbl:raw}
\end{table*}
...
\begin{figure*}
  \centering
    \subfloat[][Twitter users tend to consume technical stories.]{
      \includegraphics[width=0.45\textwidth, trim=2px 10px 2px 2px, clip]{./resources/twittertop10.png}
      \label{fig:twittertop10}}
    \qquad
    \subfloat[][Facebook users tend to consume personal stories.]{
...
\caption{The six-month entity type statistics follow a~Zipf distribution, wherein a~few types have many occurrences, and many types have few occurrences. Displayed here are schema.org types, but the same observation can be made for all ontologies and their combinations.}
\label{fig:schema}
\end{figure*}
