...
\textbf{Traditional approach:} using the traditional approach of social media mining,
it is impossible to limit the analysis to people who physically were in Norway at the moment of the attacks.
In contrast, one would filter by people that have geotagged their microposts with Norwegian locations (sparse), or that have a Norwegian location in the user profile (error-prone).
Using our approach, we can also retrieve data from people who just happened to have been in Norway at time of the attacks and that have not geotagged their microposts (more versatile).
