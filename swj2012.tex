...
\begin{abstract}
With the ever-growing influence of social networks, social media mining as well becomes more and more important as a source for responses to all sorts of questions.
...
These are just some sample questions where social networks can serve to find answers.
...
We have implemented two browser extensions for the popular social networks Facebook and Twitter that perform named entity disambiguation on microposts and, via those extensions supported by a Web analytics software, have collected half a year worth of social data.
...
In the second part, using concrete examples from recent history, we show how additional data gathered through the Web analytics software can be used to get fine-grained information on geolocations of centers of interest.
...
We see our approach not as a replacement of traditional social media mining, more as an additional perspective that makes sense in some scenarios; in the paper we present some of those.
...
Whenever a user visits a social networking site, in the concrete case Twitter or Facebook, the particular extension gets activated.
...
\caption{Global markets reach by percent of unique online visitors.}
...
\caption{Top entities as reported by browser extension users.}
...
\begin{table*}
  ...
  \caption{Top-10 locations of users of the two browser extensions (May 1 -- Nov. 12).}
