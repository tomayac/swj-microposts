...
\begin{table*}
  ...
  Table \arabic{table}: Top-10 locations of users of the two browser extensions (May~1 -- November~12).
\end{table*}
...
\begin{figure*}
  \centering
    \subfloat[][Twitter Swarm NLP]{
      \includegraphics[width=0.6\textwidth, trim=3px 2px 3px 20px, clip]{./resources/twitterswarmnlpstats.png}
      \label{fig:twitterswarmnlpstats}}
    \quad
    \subfloat[][Facebook Swarm NLP]{
      \includegraphics[width=0.6\textwidth, trim=3px 2px 3px 20px, clip]{./resources/facebookswarmnlpstats.png}
...
\begin{table*}
  ...
  \\[1em]
  \addtocounter{table}{1}
  Table \arabic{table}: Raw statistics on absolute, total and unique number of occurrences of named entities (May~1 -- November~12).
\end{table*}
...
\begin{figure*}
  \centering
    \subfloat[][Twitter]{
      \includegraphics[width=0.45\textwidth, trim=2px 2px 2px 2px, clip]{./resources/twittertypes.png}
      \label{fig:twittertypes}}
    \qquad
    \subfloat[][Facebook]{
      \includegraphics[width=0.45\textwidth, trim=2px 2px 2px 2px, clip]{./resources/facebooktypes.png}
...
For radio and television audience measurement, a Portable People Meter\footnote{Portable People Meter \url{http://www.arbitron.com/portable_people_meters/home.htm}} device  developed by a company called Arbitron is used in some parts of the United States.
...
When switching to an officially disclosed micropost audience measurement setup, the two last factors, increasing the study reach and the steadiness of the experiment participants, will resolve nicely in the sense of being the same as with traditional audience measurement.
...
More work is needed to practically compare the differences in results with common scenarios like the one proposed in the beginning: \textit{``Is my brand~B more popular in region~R on social network~A, or social network~B?''}.
