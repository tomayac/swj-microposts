...
% convert to cites, not footnotes
...
% inject negative associations, replace
...
% say we used chrome because it is famous 
...
\end{figure}
% add read microposts captured by the extensions
